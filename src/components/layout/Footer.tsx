        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/farms" className="text-gray-300 hover:text-white">
                  Farms
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/products/cumin" className="text-gray-300 hover:text-white">
                  Cumin
                </Link>
              </li>
              <li>
                <Link href="/products/saunf" className="text-gray-300 hover:text-white">
                  Saunf (Fennel)
                </Link>
              </li>
              <li>
                <Link href="/products/bajra" className="text-gray-300 hover:text-white">
                  Bajra (Pearl Millet)
                </Link>
              </li>
              <li>
                <Link href="/products/ipm-cumin" className="text-gray-300 hover:text-white">
                  IPM Cumin
                </Link>
              </li>
            </ul>
